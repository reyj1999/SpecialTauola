...
int main(int argc, char **argv) {
  ...
  string file("3ProngOutput/output_for_higgs_team.dat");
  ofstream file_out;
  file_out.open(file, std::ios_base::app);

  // Open file to write in
  string file2("3ProngOutput/IP_tau_vert.dat");
  ofstream another_file_out;
  another_file_out.open(file2, std::ios_base::app);

  // Open file to write in
  string file3("3ProngOutput/IP_pion+_3_momentum.dat");
  ofstream super_file_out;
  super_file_out.open(file3, std::ios_base::app);

  // Open file to write in
  string file4("3ProngOutput/IP_pion-_3_momentum.dat");
  ofstream fantastic_file_out;
  fantastic_file_out.open(file4, std::ios_base::app);

  // Open file to write in 
  string file5("3ProngOutput/IP_tau+_neutrino_3_momentum.dat");
  ofstream nuplus_file_out;
  nuplus_file_out.open(file5, std::ios_base::app);

  // Open file to write in
  string file6("3ProngOutput/IP_tau-_neutrino_3_momentum.dat");

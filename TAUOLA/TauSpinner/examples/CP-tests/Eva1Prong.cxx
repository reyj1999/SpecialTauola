...
int main(int argc, char **argv) {
  ...
  while(true) {
    ...
    WriteParticlesMomentumPlus(tau_daughters[2]);
    WriteParticlesMomentumPlus(tau_daughters2[2]);
/*
...
//    WriteParticles(tau2);
    ...
    WriteParticlesMomentumMinus(tau_daughters[2]);
    WriteParticlesMomentumMinus(tau_daughters2[2]);
